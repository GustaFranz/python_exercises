...
| Item | Descricao |
|------|-----------|
| **Para quem** | Iniciantes e quem quer consolidar a base antes de avancar |
| **O que treina** | Logica, sintaxe, estruturas de dados e boas praticas iniciais |
| **Como usar** | Siga a ordem numerica ou escolha um bloco por tema |
| **Cada exercicio** | Pasta propria com `README.md` (objetivo + enunciado) e `main.py` |
...
cd python_exercises/01_python_fundamentals
cd 04_funcao_format          # exemplo: troque pelo exercicio desejado
python main.py
```
...
| 102 | Ordenar disciplinas com lambda | [Abrir](./102_ordenar_disciplinas_lambda/) |
| 103 | Ordenar ranking com lambda | [Abrir](./103_ordenar_ranking_lambda/) |
| 104 | Filtrar numeros grandes com lambda | [Abrir](./104_filtrar_numeros_grandes_lambda/) |
| 105 | Filtrar palavras longas com lambda | [Abrir](./105_filtrar_palavras_longas_lambda/) |
| 106 | Dobrar numeros com map e lambda | [Abrir](./106_map_dobrar_numeros_lambda/) |
| 107 | Capitalizar nomes com map e lambda | [Abrir](./107_map_capitalizar_nomes_lambda/) |
| 108 | Arredondar medias com lambda | [Abrir](./108_round_medias_lambda/) |
| 109 | Arredondar precos com lambda | [Abrir](./109_round_precos_lambda/) |
...
| # | Exercicio | Link |
|---|-----------|------|
| 110 | Calculadora modular | [Abrir](./110_calculadora_modular/) |
| 111 | Analise de notas com modulos | [Abrir](./111_analise_notas_modulos/) |
| 112 | Organizador de arquivos por modulos | [Abrir](./112_organizador_arquivos_modulos/) |
| 113 | Cadastro de alunos modular | [Abrir](./113_cadastro_alunos_modular/) |
| 114 | Analise de vendas com modulos | [Abrir](./114_analise_vendas_modulos/) |
| 115 | Modulos em pacotes | [Abrir](./115_modulos_em_pacotes/) |
...
| # | Exercicio | Link |
|---|-----------|------|
| 116 | Planejamento de estudos com datas | [Abrir](./116_planejamento_estudos_datas/) |
| 117 | Gerador de numeros para questoes | [Abrir](./117_gerador_numeros_questoes/) |
| 118 | Simulador de sorteio de alunos | [Abrir](./118_simulador_sorteio_alunos/) |
| 119 | Analisador de texto com biblioteca padrao | [Abrir](./119_analisador_texto_biblioteca_padrao/) |
| 120 | Tempo de execucao de tarefas | [Abrir](./120_tempo_execucao_tarefas/) |
| 121 | Analisador de estatisticas com NumPy | [Abrir](./121_analisador_estatisticas_numpy/) |
...
| # | Exercicio | Link |
|---|-----------|------|
| 122 | Limpeza de base de dados de alunos | [Abrir](./122_limpeza_base_dados_alunos/) |
| 123 | Analise de vendas com estrutura de dados | [Abrir](./123_analise_vendas_estrutura_dados/) |
| 124 | Agrupamento de usuarios por idade | [Abrir](./124_agrupamento_usuarios_idade/) |
| 125 | Transformacao de dados para relatorio | [Abrir](./125_transformacao_dados_relatorio/) |
| 126 | Consolidacao de registros de sensores | [Abrir](./126_consolidacao_registros_sensores/) |
...
| # | Exercicio | Link |
|---|-----------|------|
| 127 | Consulta de clima via API | [Abrir](./127_consulta_clima_api/) |
| 128 | Cotacao de moeda em tempo real | [Abrir](./128_cotacao_moeda_tempo_real/) |
| 129 | Consulta de livros via API | [Abrir](./129_consulta_livros_api/) |
| 130 | Gerador de fatos aleatorios | [Abrir](./130_gerador_fatos_aleatorios/) |
...
| # | Exercicio | Link |
|---|-----------|------|
| 131 | Entrada segura de notas | [Abrir](./131_entrada_segura_notas/) |
| 132 | Leitor seguro de divisao | [Abrir](./132_leitor_seguro_divisao/) |
...
| **Codigo** | `main.py` em cada pasta; mensagens ao usuario podem usar acentos |
