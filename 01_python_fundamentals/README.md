...
> **Organizacao em andamento:** os exercicios ainda estao na raiz do repositorio. Na proxima etapa, todas as pastas `NN_snake_case` serao movidas para dentro desta pasta. Os links abaixo ja apontam para o caminho atual.
...
1. Entre na pasta do exercicio (hoje na raiz do repo)
