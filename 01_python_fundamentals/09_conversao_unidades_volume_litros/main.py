...
# Solicita ao usuário um valor em litros
litros = float(input("Digite o valor em litros (L) que você deseja fazer a conversão: "))

# Realiza as conversões para outras unidades de volume
kl = litros / 1000
hl = litros / 100
dal = litros / 10
dl = litros * 10
