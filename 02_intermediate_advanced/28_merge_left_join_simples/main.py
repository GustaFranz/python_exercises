...
# EXERCICIO 28 - Merge: left join simples (contexto corporativo)
#
# turma = [
...
#
# ORIENTACOES
## Para cada aluno em turma, busque notas.get(matricula, "sem nota").
## Left join = preservar todos da lista principal.
