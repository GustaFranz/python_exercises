...
# EXERCICIO 29 - Merge: tratar registros ausentes (contexto corporativo)
#
...
#
# ORIENTACOES
## Itere pacientes (fonte principal).
## if paciente in resultados: ... else: pendente.
## Armazene flag booleana para auditoria.
