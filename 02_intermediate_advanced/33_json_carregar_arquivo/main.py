...
# EXERCICIO 33 - JSON: carregar arquivo (contexto corporativo)
#
...
#
# ORIENTACOES
## json.load(arquivo) dentro de with open(..., encoding="utf-8").
## try/except FileNotFoundError para arquivo inexistente.
## Loop for na lista retornada.
