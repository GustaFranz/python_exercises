...
# EXERCICIO 93 - HTTP: mensagem amigavel (contexto corporativo)
#
...
# Implemente mensagem_para_usuario(resposta) recebendo dict com status.
# Teste com os 3 status acima.
#
# ORIENTACOES
## Funcao pura que recebe dict e retorna string amigavel.
## Nao exponha detalhes tecnicos ao usuario final.
