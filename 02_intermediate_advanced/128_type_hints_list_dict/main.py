...
# EXERCICIO 128 - Type hints: list e dict (contexto corporativo)
#
...
## Media dos tamanhos; 0.0 se lista vazia
# Teste com ["ana", "bolo", "escola"].
#
# ORIENTACOES
## list[str] no parametro; dict[str, int] no retorno de contar_tamanhos.
