...
# EXERCICIO 39 - CSV: delimitador ponto e virgula (contexto corporativo)
#
...
#
# ORIENTACOES
## DictWriter(..., delimiter=";").
## Excel BR espera ; como separador de colunas.
## encoding utf-8-sig opcional para Excel abrir acentos corretamente.
