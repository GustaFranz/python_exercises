...
# EXERCICIO 36 - JSON: sincronizar memoria e arquivo (contexto corporativo)
#
...
#
# ORIENTACOES
## Validar antes de append.
## carregar() no inicio do programa.
## salvar() apos cada mudanca — sincronia imediata.
## Pode usar funcoes e lista global ou classe simples.
