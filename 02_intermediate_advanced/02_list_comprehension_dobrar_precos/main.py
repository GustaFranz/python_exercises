...
# EXERCICIO 02 - List comprehension: dobrar precos (contexto corporativo)
#
...
#
# ORIENTACOES
## Use: [preco * 2 for preco in precos]
## Exiba com labels claros: "Precos atuais" e "Precos simulados".
