...
# EXERCICIO 123 - Assert: casos de borda (contexto corporativo)
#
# Implemente nota_maxima(notas):
...
#
# ORIENTACOES
## Casos de borda = extremos e situacoes incomuns.
## Trate lista vazia explicitamente.
